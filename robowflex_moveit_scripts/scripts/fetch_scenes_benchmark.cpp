 ...
 * pairs are included in 'package://robowflex_moveit_scripts/yaml/fetch_scenes'. This
...
int main(int argc, char **argv)
{
    ...
    for (std::size_t i = start; i <= end; i++)
    {
        const auto &scene_file =
            log::format("package://robowflex_moveit_scripts/yaml/fetch_scenes/scene_vicon%1$04d.yaml", i);
        const auto &request_file =
            log::format("package://robowflex_moveit_scripts/yaml/fetch_scenes/request%1$04d.yaml", i);
