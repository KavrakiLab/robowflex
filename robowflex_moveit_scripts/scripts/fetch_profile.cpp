...
int main(int argc, char **argv)
{
    ...
    scene->fromYAMLFile("package://robowflex_moveit_scripts/yaml/fetch_box/scene0001.yaml");
    ...
    request->fromYAMLFile("package://robowflex_moveit_scripts/yaml/fetch_box/request0001.yaml");
