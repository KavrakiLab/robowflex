...
namespace robowflex
{
    ...
    /** \class robowflex::MoveItGeometryPtr
        \brief A shared pointer wrapper for robowflex::Geometry. */

    /** \class robowflex::MoveItGeometryConstPtr
        \brief A const shared pointer wrapper for robowflex::Geometry. */

    /** \brief A wrapper for MoveIt's underlying representation of solid geometry.
     */
    class MoveItGeometry : public Geometry
    {
    public:
         ...
         */
        static MoveItGeometryPtr makeSphere(double radius);
         ...
         */
        static MoveItGeometryPtr makeBox(double x, double y, double z);

        /** \brief Create a box.
         *  \param[in] dimensions The XYZ dimensions of the box.
         *  \return The created box.
         */
        static MoveItGeometryPtr makeBox(const Eigen::Vector3d &dimensions);
         ...
         */
        static MoveItGeometryPtr makeCylinder(double radius, double length);
         ...
         */
        static MoveItGeometryPtr makeCone(double radius, double length);

        /** \brief Create a solid primitive.
         *  \param[in] msg The solid primitive message to load.
         *  \return The created shape.
         */
        static MoveItGeometryPtr makeSolidPrimitive(const shape_msgs::SolidPrimitive &msg);
         ...
         */
        static MoveItGeometryPtr makeMesh(const std::string &resource,
         ...
         *  \return The created mesh.
         */
        static MoveItGeometryPtr makeMesh(const std::vector<Eigen::Vector3d> &vertices);
         ...
         */
        bool contains(const Eigen::Vector3d &point) const override;
         ...
         */
        std::pair<bool, Eigen::Vector3d> sample(const unsigned int attempts = 50) const override;
         ...
         *  \return The AABB.
         */
        Eigen::AlignedBox3d getAABB(const RobotPose &pose = RobotPose::Identity()) const override;
