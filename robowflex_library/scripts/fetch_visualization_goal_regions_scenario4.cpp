...
int main(int argc, char **argv)
{
    ...
    scene->fromYAMLFile("package://robowflex_library/yaml/test_fetch_goal_regions_scenario4.yml");
    ...
    target_pose_grasp.pose.position.z = 0.73;
    ...
    goal_region.z.min = target_pose_grasp.pose.position.z - 0.03;
    goal_region.z.max = target_pose_grasp.pose.position.z + 0.03;
    ...
    target_pose_grasp.pose.position.z = 0.72;
    target_pose_grasp.pose.orientation.x = 0.0;
    target_pose_grasp.pose.orientation.y = 0.0;
    target_pose_grasp.pose.orientation.z = 0.0;
    target_pose_grasp.pose.orientation.w = 1.0;
    ...
    request->setPoseRegionTargets(goal_poses, goal_regions, "gripper_link");
