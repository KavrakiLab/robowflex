...
/** \def Tests if this MoveIt version is has started to use CollisionEnv over World */
#define ROBOWFLEX_MOVEIT_COLLISION_ENV (ROBOWFLEX_MOVEIT_VERSION >= ROBOWFLEX_MOVEIT_VERSION_COMPUTE(1, 0, 2))
