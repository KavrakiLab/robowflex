...
tesseract::tesseract_ros::KDLEnvPtr hypercube::constructTesseractEnv(robowflex::SceneConstPtr scene, robowflex::RobotConstPtr robot)
{
    ...
    for (auto collision_object : scene_msg.world.collision_objects)
    {
        ...
        for (shape_msgs::SolidPrimitive primitive : collision_object.primitives)
        {
            ...
            obj.collision.primitive_collision_object_types.push_back(cot);
        }
