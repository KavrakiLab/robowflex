 ...
 * A simple script that shows how to use TrajOpt to plan in a manipulation task. The scene and request are loaded from yaml files. Instead of providing a goal state, a goal pose for the end effector is encoded as a cartesian constraint. An RVIZ Helper object is used to visualize the start/end states and the computed trajectory.
 */
