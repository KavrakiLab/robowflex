...
namespace robowflex
{
    ...
    namespace hypercube
    {
        ...
        /** \brief Transform a \a robot_state to a vector representing joint values for the manipulator (in the order given by \a manip_joint_names).
        ...
        /** \brief Transform a tesseract \a waypoint (manip state) to robot \a state. Joint values for non-manip joints are taken from env.
